...
pub(crate) const ES_FLUENT_GITHUB_URL: &str = "https://github.com/stayhydated/es-fluent";

pub(crate) const KORUMA_SITE_URL: &str = "/koruma/";
pub(crate) const ES_FLUENT_SITE_URL: &str = "/es-fluent/";
